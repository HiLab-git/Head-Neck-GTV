...
class UnetUp3_CT2(nn.Module):
    def __init__(self, in_size, out_size, is_batchnorm=True):
        ...
        self.conv = UNetBlock(in_size + out_size, out_size, is_batchnorm, kernel_size=(1,3,3), padding_size=(0,1,1))
...
class UnetUp3_CT(nn.Module):
    def __init__(self, in_size, out_size, is_batchnorm=True):
        ...
        self.conv = UnetConv3(in_size + out_size, out_size, is_batchnorm, kernel_size=(1,3,3), padding_size=(0,1,1))
