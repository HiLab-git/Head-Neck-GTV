...
This repository proivdes source code for automatic segmentation of Gross Target Volume (GTV) of Nasopharynx Cancerusing (NPC) from CT images according to the following paper:
